...
def package_data():
    ...
    """
    file_set = []
    for root, dirs, files in os.walk("athanor_factions"):
        for f in files:
...
setup(
    ...
    project_urls={
        "Source": "https://github.com/volundmush/athanor_factions",
        "Issue tracker": "https://github.com/volundmush/athanor_factions/issues",
    },
)
